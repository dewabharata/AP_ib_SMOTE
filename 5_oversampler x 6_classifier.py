...
for dataset_name in datasets:
    ...
    for oversampler_name, oversampler in oversamplers.items():
        for clf_name, clf in classifiers.items():
            ...
            csv_file_path = f"C:\\Users\\USER\\Documents\\Kevin\\Wistron Results\\{oversampler_name}_{clf_name}\\{dataset_name}_{oversampler_name}.csv"
...
for (oversampler_name, clf_name), results in all_results.items():
    ...
    average_csv_file_path = f"C:\\Users\\USER\\Documents\\Kevin\\Wistron Results\\{oversampler_name}_{clf_name}\\Average2_{oversampler_name}_{clf_name}.csv"
    ...
    new_directory_path = f"C:\\Users\\USER\\Documents\\Kevin\\Wistron ALL_Results\\{clf_name}"

    if not os.path.exists(new_directory_path):
        os.makedirs(new_directory_path)
    destination_file_path = f"{new_directory_path}\\Average2_{oversampler_name}_{clf_name}.csv"
